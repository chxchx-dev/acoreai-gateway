    ...
    <div className="ob-overlay">
      ...
      <div className="ob-card">
        ...
        <div className="ob-logo-row">
          <img src={logoAiAlania} alt="AlanIA" className="ob-logo" />
          <span className="ob-logo-name">AlanIA</span>
        </div>
...
function StepWelcome({ firstName }: { firstName: string }) {
  return (
    <div className="ob-welcome">
      <img src={alaniaHola} alt="AlanIA saludando" className="ob-welcome-avatar" />
      <h1 className="ob-welcome-title">
        Hola, <span className="ob-accent-text">{firstName}</span> 👋
      </h1>
      <p className="ob-welcome-desc">
        Antes de empezar, AlanIA necesita conocer tu objetivo para adaptar las
...
function StepCorrection({
  ...
  return (
    <div className="ob-step">
      <h2 className="ob-step-title">¿Cómo quieres que AlanIA corrija tu inglés?</h2>
      <div className="ob-option-grid">
