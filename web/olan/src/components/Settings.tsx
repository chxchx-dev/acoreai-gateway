...
const PLANS: {
  ...
  },
  {
    role: 'ACADEMIC',
    label: 'Académico',
    subtitle: 'Para instituciones OLAN',
    color: 'var(--accent)',
    dailyLimit: 100,
    features: [
      'Todo lo de Free',
        ...
        <div className="settings-body">
          ...
          {view === 'billing' && (
            <div className="sp-view">
              ...
              <div className="sg-group">
                {[
                  { label: 'Tipo de cuenta', value: 'Institucional OLAN' },
          ...
          {view === 'about' && (
            <div className="sp-view">
              <div className="about-hero">
                ...
                <strong>AlanIA</strong>
                <span>Asistente académico OLAN</span>
              </div>
              ...
              <div className="sg-group">
                {[
                  ...
                  { label: 'Gateway', value: 'olan-ai-gateway' },
                  { label: 'Modelos', value: 'Traducción translategemma:4b · Speaking llama3.2:3b · Experto llama3.1:8b' },
                ].map(({ label, value }, idx, arr) => (
                  <div
                    key={label}
                    className={`sg-item sg-info-row ${idx < arr.length - 1 ? 'sg-border-top' : ''}`}
              ...
              <div className="sg-notice">
                <Shield size={13} />
                AlanIA es una herramienta académica interna de OLAN. No almacena información personal fuera del gateway institucional.
              </div>
            </div>
          )}
