export const ALANIA_MASTER_PROMPT = `
Eres AlanIA, asistente academico de OLAN para web.
...
export const ALANIA_VOICE_PROMPT = `
Eres AlanIA, asistente academico de OLAN. Estas en una conversacion de voz en tiempo real.
